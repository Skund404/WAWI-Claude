...
class DatabaseService:
    ...
    @inject(MaterialService)
    def get_repository(self, model_name: str, session: Session) -> BaseRepository:
        """
    ...
    @inject(MaterialService)
    def get_all(self, model_name: str, limit: Optional[int] = None, offset: Optional[int] = None) -> List[Any]:
        """
    ...
    @inject(MaterialService)
    def update(self, model_name: str, id: int, data: Dict[str, Any]) -> Optional[Any]:
        """
    ...
    @inject(MaterialService)
    def search(self, model_name: str, search_term: str, fields: List[str]) -> List[Any]:
        """
        ...
        try:
            ...
            logger.error(f"Error searching {model_name} for '{search_term}': {str(e)}")
            return []
