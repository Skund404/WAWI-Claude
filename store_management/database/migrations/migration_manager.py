        ...
        try:
            ...
            for rev_old, rev_new in pending:
                if rev_old == current_rev or rev_old is None:
                    result.append({
                        'revision': rev_new.revision,
                        'description': rev_new.doc,
                        'created_date': rev_new.created_date.isoformat() if rev_new.
...
def main():
    ...
    create_parser.add_argument(
        'message', help='Migration message/description')
    create_parser.add_argument(
    ...
    if args.command == 'info':
        ...
        revision = manager.create_migration(
            args.message, not args.no_autogenerate)
