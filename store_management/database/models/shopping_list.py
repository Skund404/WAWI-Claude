...
from sqlalchemy import Column, Integer, String, Float, ForeignKey, Enum as SQLAEnum, DateTime
from sqlalchemy.orm import relationship

from database.models.base import Base
from database.models.enums import ShoppingListStatus
...
class ShoppingList(Base):
    ...
    status = Column(SQLAEnum(ShoppingListStatus), default=ShoppingListStatus.ACTIVE)
...
class ShoppingListItem(Base):
    ...
    def __init__(self, name: str, quantity: float = 1.0, unit: Optional[str] = None,
                 priority: int = 0, notes: Optional[str] = None):
        """
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"<ShoppingListItem(id={self.id}, name='{self.name}', quantity={self.quantity})>"
