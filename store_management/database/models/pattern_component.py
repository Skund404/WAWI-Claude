...
from sqlalchemy import Column, Integer, String, Float, Boolean, ForeignKey, CheckConstraint, Enum as SQLAEnum, JSON, DateTime
...
class PatternComponent(BaseModel, TimestampMixin, ValidationMixin, Base):
