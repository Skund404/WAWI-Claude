...
from sqlalchemy import Column, Integer, String, Float, DateTime, Boolean, Enum as SQLAEnum
...
class Pattern(Base):
    ...
    def create_template(cls, name: str, project_type: ProjectType,
        ...
        """
        return cls(name=name, project_type=project_type, skill_level=skill_level,
                   estimated_labor_hours=estimated_labor_hours,
                   description=description, is_template=True, stitch_type=stitch_type,
                   edge_finish_type=edge_finish_type, pattern_pieces={}, leather_specifications={},
