    ...
    try:
        try:
            ...
            try:
                ...
                if storage_count == 0:
                    sample_storages = [Storage(name='Main Storage',
                        location='Warehouse A', capacity=1000.0,
                        current_occupancy=0.0, type='Warehouse',
                        description='Main storage location', status=
                        'Active'), Storage(name='Secondary Storage',
                        location='Warehouse B', capacity=500.0,
                        current_occupancy=0.0, type='Warehouse',
                        description='Secondary storage location', status=
                        'Active'), Storage(name='Workshop Storage',
                        location='Workshop', capacity=200.0,
                        current_occupancy=0.0, type='Workshop', description
                        ='Workshop storage location', status='Active')]
            ...
            try:
                ...
                if supplier_count == 0:
                    sample_suppliers = [Supplier(name='Leather Supply Co.',
                        contact_name='John Smith', email=
                        'john@leathersupply.com', phone='555-1234', address
                        ='123 Main St, Leather City', tax_id='LS12345'),
                        Supplier(name='Hardware Emporium', contact_name=
                        'Jane Doe', email='jane@hardwareemporium.com',
                        phone='555-5678', address=
                        '456 Market St, Hardware Town', tax_id='HE67890')]
...
def initialize_database(drop_existing: bool=False, use_fallback: bool=False
    ) ->bool:
    """
        ...
        if use_fallback and database_url.startswith('sqlite:///'):
            ...
            if drop_existing:
                ...
                backup_file = os.path.join(backup_path,
                    f'backup_before_init_{timestamp}.db')
