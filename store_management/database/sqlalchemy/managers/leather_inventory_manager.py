        ...
        try:
            with self.session_scope() as session:
                ...
                transaction = LeatherTransaction(leather_id=leather.id,
                    ...
                    'initial_area'], unit_price=data['unit_price'], notes=
                    'Initial stock entry', created_at=datetime.now())
        ...
        try:
            with self.session_scope() as session:
                ...
                transaction = LeatherTransaction(leather_id=leather_id,
                    transaction_type=transaction_type, area_change=
                    area_change, remaining_area=new_area, wastage=wastage,
