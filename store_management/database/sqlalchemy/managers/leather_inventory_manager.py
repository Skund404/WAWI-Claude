...
class LeatherInventoryManager(BaseManager[Leather]):
    ...
    def add_leather(self, data: Dict[str, Any]) -> Leather:
        ...
        try:
            with self.session_scope() as session:
                ...
                session.add(leather)
                session.flush()  # Get ID for the leather
            ...
            with self.session_scope() as session:
                ...
                if include_wastage:
                    ...
                    result.update({
                        ...
                        "wastage_percentage": (
                            (total_wastage / leather.total_area * 100)
    ...
    def calculate_leather_efficiency(
        ...
        try:
            ...
            raise DatabaseError(f"Failed to calculate leather efficiency: {str(e)}")
