...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "time_frame",
            postgresql.ENUM("daily", "weekly", "monthly", name="timeframe"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("waste_amount", sa.Float(),
    ...
    op.create_index("ix_metric_snapshots_timestamp",
                    "metric_snapshots", ["timestamp"])
    op.create_index(
        "ix_metric_snapshots_metric_type", "metric_snapshots", ["metric_type"]
    )
    op.create_index(
        "ix_material_usage_logs_timestamp", "material_usage_logs", [
            "timestamp"]
    )
    op.create_index(
        "ix_material_usage_logs_material_id", "material_usage_logs", [
            "material_id"]
    )
