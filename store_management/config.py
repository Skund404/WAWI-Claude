...
TABLES = {'SUPPLIER': 'supplier', 'SHELF': 'shelf', 'STORAGE': 'storage',
    'RECIPE_INDEX': 'recipe_index', 'RECIPE_DETAILS': 'recipe_details',
    'SORTING_SYSTEM': 'sorting_system'}
COLORS = {'WARNING': '#ffcccc', 'CRITICAL': '#ff8080', 'WARNING_LIGHT':
    '#ffe6cc', 'SUCCESS': '#ccffcc', 'NORMAL': '#ffffff', 'HEADER':
    '#f0f0f0', 'PRIMARY': '#007bff', 'SECONDARY': '#6c757d'}
DEFAULT_PADDING = 5
