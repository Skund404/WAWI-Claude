# Path: tests/test_project_workflow_manager.py

import unittest
from unittest.mock import Mock, patch
from datetime import datetime, timedelta
from services.project_workflow_manager import ProjectWorkflowManager, ProjectType, SkillLevel, ProjectStatus, ProjectMaterial, ProjectTask

class TestProjectWorkflowManager(unittest.TestCase):

    def setUp(self):
        self.mock_material_service = Mock()
        self.workflow_manager = ProjectWorkflowManager(self.mock_material_service)
    ...
    def test_update_project_details(self):
        ...
        success = self.workflow_manager.update_project_details(
            project_id,
    ...
    def test_update_project_status(self):
        ...
        success = self.workflow_manager.update_project_status(project_id, ProjectStatus.DESIGN)
        self.assertTrue(success)
        project = self.workflow_manager.projects[project_id]
    ...
    def test_add_project_material(self):
        ...
        success = self.workflow_manager.add_project_material(
            project_id,
            "LEATHER-001",
    ...
    def test_update_material_usage(self):
        project_id = self.workflow_manager.create_project(
            ...
            project_type=ProjectType.GARMENT,
            skill_level=SkillLevel.INTERMEDIATE
        )
        self.workflow_manager.add_project_material(
            project_id,
            "FABRIC-001",
            expected_quantity=10.0
        )
        success = self.workflow_manager.update_material_usage(
            project_id,
            "FABRIC-001",
            actual_quantity=9.5,
            wastage=0.5
    ...
    def test_update_task_status(self):
        ...
        success = self.workflow_manager.update_task_status(
            project_id,
            task_id,
            status="IN_PROGRESS",
