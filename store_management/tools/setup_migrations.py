...
template_env = project_root / "database" / "migrations" / "env.py.template"
...
template_script = (
project_root / "database" / "migrations" / "script.py.mako.template"
)
...
"Create initial migration? (y/n): ").strip().lower()
