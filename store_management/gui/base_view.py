# Relative path: store_management/views/base_view.py

"""
Base view module for the application.

Provides the abstract base class for all views in the application.
"""
