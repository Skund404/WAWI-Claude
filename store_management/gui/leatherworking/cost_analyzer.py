...
class ProjectCostAnalyzer(BaseView):
    ...
    def __init__(self, parent: tk.Widget, app: Any) -> None:
        ...
        self.labor_rate = Decimal('25.00')  # Default hourly rate
    ...
    def create_toolbar(self) -> None:
        ...
        type_combo = ttk.Combobox(
            ...
            values=["ALL"] + [t.name for t in ProjectType],
            state="readonly",
            width=15
        )
    ...
    def create_cost_section(self) -> None:
        ...
        # Create pricing recommendations tab
    ...
    def create_cost_breakdown(self, parent: ttk.Frame) -> None:
        ...
        Args:
            parent: Parent frame
        """
        # Create sections for different cost types
        sections = [
            ("Materials", "materials_frame"),
            ("Labor", "labor_frame"),
            ("Hardware", "hardware_frame"),
            ("Overhead", "overhead_frame")
        ]
    ...
    def create_profitability_analysis(self, parent: ttk.Frame) -> None:
        ...
        margin_scale = ttk.Scale(
            ...
            command=self.update_profitability
        )
    ...
    def calculate_total_cost(self, project: Project) -> Decimal:
        ...
        try:
            ...
            # Add overhead (percentage of materials + labor)
    ...
    def update_cost_breakdown(self) -> None:
        ...
        try:
            ...
            ttk.Label(
                labor_frame,
                text=f"Hours: {labor_hours}"
            ).pack(side=tk.LEFT)
            ttk.Label(
                labor_frame,
                text=f"Rate: ${self.labor_rate}/hr"
            ).pack(side=tk.LEFT, padx=10)
            ttk.Label(
                labor_frame,
                text=f"Total: ${labor_cost:.2f}"
            ).pack(side=tk.RIGHT)

            # Update overhead frame
            ...
            ttk.Label(
                overhead_frame,
                text="15% of base cost"
            ).pack(side=tk.LEFT)
            ttk.Label(
                overhead_frame,
                text=f"${overhead_cost:.2f}"
            ).pack(side=tk.RIGHT)
            ...
            # Store cost data for other analyses
            self.cost_data = {
    ...
    def save_settings(self) -> None:
        ...
        try:
            settings = {
                "labor_rate": str(self.labor_rate)
            }
    ...
    def update_labor_rate(self, *args) -> None:
        ...
        try:
            ...
            # Update calculations if project selected
