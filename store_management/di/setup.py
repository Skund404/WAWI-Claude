            ...
            def create_lazy_registration(interface, module, cls):
                def lazy_loader():
                    try:
                        ...
                        # Special handling for Supplier Service to log initialization
                        if interface == 'services.interfaces.supplier_service.ISupplierService':
                            logger.info(f"Initializing {interface} with implementation {cls}")
